...
from azure.mgmt.costmanagement.models import (
    QueryFilter, QueryComparisonExpression, QueryFilterAutoGenerated
)
import logging
...
def cost_filters(
    ...
    ) -> Optional[QueryFilterAutoGenerated]:
    """
    ...
    Returns:
        QueryFilterAutoGenerated object or None if no filters
    """
    filters = []
...
def build_complex_filter(
    ...
    Returns:
        Complex QueryFilterAutoGenerated object or None
    """
