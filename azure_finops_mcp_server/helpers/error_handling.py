...
class ErrorHandler:
    ...
    @staticmethod
    def log_error(error: Exception, context: str, details: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    @staticmethod
    def create_error_response(error: Exception, context: str, safe_message: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                return ErrorHandler.create_error_response(
                    e, context, "Authentication failed. Please check your Azure credentials."
                )
            except AzureResourceNotFoundError as e:
                ErrorHandler.log_error(e, context, {"operation": "resource_access"})
                return ErrorHandler.create_error_response(e, context, "The requested resource was not found.")
            except AzureRateLimitError as e:
                ErrorHandler.log_error(e, context, {"operation": "api_call"})
                return ErrorHandler.create_error_response(
                    e, context, "Azure API rate limit exceeded. Please try again later."
                )
            except AzureAPIError as e:
                ErrorHandler.log_error(e, context, {"operation": "api_call"})
                return ErrorHandler.create_error_response(e, context, "Azure API error occurred. Please try again.")
            except Exception as e:
                ErrorHandler.log_error(e, context, {"operation": "unknown"})
                return ErrorHandler.create_error_response(e, context, "An unexpected error occurred.")
