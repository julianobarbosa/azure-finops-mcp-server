...
from azure_finops_mcp_server.helpers.azure_client_factory import reset_client_factory, set_client_factory
...
class TestVMOperationsIntegration:
    ...
    def test_get_stopped_vms_with_parallel_processing(self, mock_get_factory):
        ...
        mock_compute_client.virtual_machines.instance_view.side_effect = [instance1, instance2, instance3]
...
class TestParallelProcessingIntegration:
    ...
    def test_parallel_subscription_processing(self, mock_get_factory):
        ...
        subscriptions = {"sub1": ["Subscription 1"], "sub2": ["Subscription 2"], "sub3": ["Subscription 3"]}
        ...
        results, errors = processor.process_subscriptions(
            subscriptions=subscriptions, process_func=process_func, credential=Mock()
        )
...
class TestRetryLogicIntegration:
    ...
    def test_retry_on_transient_error(self):
        ...
        from azure_finops_mcp_server.helpers.retry_handler import RetryConfig, RetryHandler
